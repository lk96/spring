...
import com.inspur.domain.ActionType;
import com.inspur.domain.ChangeItem;
import com.inspur.util.DiffUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.inspur.aop.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.inspur.aop.dao.*.delete*(..))")
    public void delete(){
